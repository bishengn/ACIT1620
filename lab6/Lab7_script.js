...
const newColor = document.getElementById('addColorForm');
const inputNewColor = document.getElementById('colorInput');
...
colorButtons.addEventListener('click', function(event) {
  if (event.target.classList.contains('color-btn')) {
    ...
    colorBox.style.backgroundColor = selectColor;
    colorBox.textContent = selectColor;
  }
});
